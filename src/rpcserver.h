...
extern json_spirit::Value poolmine(const json_spirit::Array& params, bool fHelp);
extern json_spirit::Value mhash(const json_spirit::Array& params, bool fHelp);
...
extern json_spirit::Value getfeerate(const json_spirit::Array& params, bool fHelp);
