...
//! -maxtxfee default
static const CAmount DEFAULT_TRANSACTION_MAXFEE = MAX_MONEY;
...
public:
    ...
    int GetBlocksToMaturity(int nPos=-1) const;
    bool AcceptToMemoryPool(bool fLimitFree=true, bool fRejectInsaneFee=false);
};
